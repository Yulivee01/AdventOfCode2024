...
TEST(day_5_part2, test_with_aoc_example)
{
    ...
    EXPECT_EQ(123, make_updates_valid(rules, updates));
}

TEST(day_5_part2, test_with_full_input)
{
    const auto rules = read_rules("day5/input_day5_1.txt");
    const auto updates = read_updates("day5/input_day5_2.txt");
    EXPECT_EQ(4230, make_updates_valid(rules, updates));
}