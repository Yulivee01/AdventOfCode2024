...
TEST(day_7_part2, test_with_aoc_example)
{
    ...
    EXPECT_EQ(11387, find_valid_calibrations2(calibrations));
}

TEST(day_7_part2, test_with_full_input)
{
    const auto calibrations = read_input_day7("day7/input_day7.txt");
    EXPECT_EQ(362646859298554, find_valid_calibrations2(calibrations));
}